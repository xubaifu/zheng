...
<div id="subsetColumnDialog" class="crudDialog">
	<form id="subsetColumn" method="post">
		...
		<div class="form-group text-right dialog-buttons">
			...
			<a class="waves-effect waves-button" href="javascript:;" onclick="subsetColumnDialog.close();">取消</a>
		</div>
	</form>
</div>
<script>
function createSubsetColumn(){
	$.ajax({
        type: 'post',
        url: '${basePath}/manage/user/insertSubsetColumnData',
